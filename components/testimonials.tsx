...
const Marquee = ({
  ...
  return (
    ...
    >
      <div className={cn("flex animate-marquee gap-4 py-4", reverse && "animate-marquee-reverse")}>
        {children}
        {children}
      </div>
    </div>
      ...
      <div className="container mx-auto px-4">
        <div className="flex flex-col md:flex-row items-center">
          <div className="md:w-1/2 mb-8 md:mb-0 text-left">
            ...
            <h3 className="text-3xl md:text-4xl font-bold text-[#0a2540] dark:text-white">What Our Clients Say</h3>
            <p className="text-gray-600 dark:text-gray-300 mt-4 max-w-md">
              Don't just take our word for it. Here's what our clients have to say about working with BrandBounce.
            </p>
          </div>
