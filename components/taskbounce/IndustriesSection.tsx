...
const industries: IndustryCard[] = [
  {
    title: 'Tech & Startups',
    icon: '🏢',
    description: 'Scale your dev team with on-demand engineers, UX designers, and interim CTOs.',
  ...
  },
  {
    title: 'E-Commerce',
    icon: '📦',
    description: 'Flexible logistics, marketing, and customer support specialists for peak seasons.',
  ...
  },
  {
    title: 'Healthcare',
    icon: '🏥',
    description: 'HIPAA-compliant developers and consultants for sensitive projects.',
  ...
  // Add more industries as needed
  {
    title: 'Finance',
    icon: '💰',
    description: 'Secure data analysts and compliance experts for financial operations.',
  ...
  },
  {
    title: 'Nonprofits',
    icon: '🤝',
    description: 'Grant writers and event coordinators to amplify your mission.',
  ...
  },
  {
    title: 'Education',
    icon: '📚',
    description: 'Curriculum developers and administrative support for educational institutions.',
    ...
    <section className="w-full py-16 bg-[#F5F5F5] text-[#37474F]">
      ...
      <div className="container mx-auto px-4 text-center">
        ...
        <p className="text-lg text-[#37474F] mb-12 font-['Source_Sans_Pro']">
          TaskBounce connects you with specialists who speak your industry’s language.
        </p>
      </div>
      ...
      <div className="container mx-auto px-4 mt-12">
        <div className="flex flex-col md:flex-row justify-around items-center bg-[#26A69A] text-white py-8 rounded-lg">
          <div className="text-center mb-6 md:mb-0">
            ...
            <p className="font-['Source_Sans_Pro']">Projects delivered in 12 industries</p>
          </div>
          <div className="text-center mb-6 md:mb-0">
